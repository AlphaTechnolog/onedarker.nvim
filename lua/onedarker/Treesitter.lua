local Treesitter = {
  TSComment = { fg = C.gray, style = Config.italic_comments },
  ...
  TSFunction = { fg = C.blue, style = Config.italic_functions },
  ...
  TSVariable = { fg = C.fg, style = Config.italic_variables },
  ...
  TSPunctBracket = { fg = C.fg, style = "NONE" },
