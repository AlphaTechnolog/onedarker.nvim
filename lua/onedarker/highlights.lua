local highlights = {
  ...
  Comment = { fg = C.gray, style = Config.italic_comments },
  ...
  Variable = { fg = C.cyan, style = Config.italic_variables },
  String = { fg = C.green },
  ...
  Float = { fg = C.orange },
  Identifier = { fg = C.fg },
  Function = { fg = C.blue, style = Config.italic_functions },
  Operator = { fg = C.purple },
  Type = { fg = C.yellow },
  StorageClass = { fg = C.cyan },
  Structure = { fg = C.purple },
  Typedef = { fg = C.purple },
  Keyword = { fg = C.purple, style = Config.italic_keywords },
